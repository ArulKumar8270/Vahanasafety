    ...
    const state = [
             ...
             <div className='w-full'>
              ...
              <div className="container px-6 mx-auto grid">
                ...
                >
                  ...
                  <Link to="/company"> <button className='bg-white p-2 rounded-md text-purple-600' >Company List</button>
                  </Link>
                </div>
      ...
      <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 12h16.5m-16.5 3.75h16.5M3.75 19.5h16.5M5.625 4.5h12.75a1.875 1.875 0 0 1 0 3.75H5.625a1.875 1.875 0 0 1 0-3.75Z" />
                          ...
                          <select className="relative z-20 w-full appearance-none rounded border border-stroke bg-transparent py-3 px-12 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input">
                            ...
                            <option className='text-black-500' value={district.district}>{district.district}</option>
                            )
                          }
      ...
      <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 12h16.5m-16.5 3.75h16.5M3.75 19.5h16.5M5.625 4.5h12.75a1.875 1.875 0 0 1 0 3.75H5.625a1.875 1.875 0 0 1 0-3.75Z" />
                          ...
                          <select className="relative z-20 w-full appearance-none rounded border border-stroke bg-transparent py-3 px-12 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input">
                            ...
                            {
                            state.map((name)=>
                            <option className='text-black-500' value={name.state}>{name.state}</option>
                            )
                          }
          ...
          <div className='flex justify-items-center items-center w-full'><h3 className='text-black font-bold mt-4 text-center'></h3></div>
