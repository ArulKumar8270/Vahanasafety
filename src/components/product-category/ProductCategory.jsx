...
function ProductCategory() {
  ...
  const notify = () => toast("Category Added Success");
             ...
             <div className='w-full'>   
              ...
              <div className="container px-6 mx-auto grid">
                ...
                >
                  ...
                  <button onClick={()=> setShowModel(true)} className='bg-white p-2 rounded-md text-purple-600' >Add Category</button>
                </a>
                ...
                {ShowModel && <AddCategory toast={notify} /> }
